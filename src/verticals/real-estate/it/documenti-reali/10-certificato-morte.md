...
```json
{
  ...
  "properties": {
    ...
    "codiceFiscaleDefunto": { "type": "string", "pattern": "^[A-Z]{6}[0-9]{2}[A-Z][0-9]{2}[A-Z][0-9]{3}[A-Z]$" },
  ...
  "required": ["nomeDefunto", "cognomeDefunto", "dataDecesso", "luogoMorte", "comuneRegistrazione"]
}
```
