...
```json
{
  "type": "object",
  "properties": {
    "classeEnergetica": { "type": "string", "enum": ["A4", "A3", "A2", "A1", "B", "C", "D", "E", "F", "G", null] },
  ...
  "required": ["classeEnergetica", "indiceEpgl", "codiceIdentificativo", "validoFinoA", "regione", "comune", "indirizzo", "piano", "interno", "comuneCatastale", "sezione", "foglio", "particella", "subalterni", "destinazioneUso", "oggettoAttestato", "dataScadenza", "codiceUnivoco"]
}
```
