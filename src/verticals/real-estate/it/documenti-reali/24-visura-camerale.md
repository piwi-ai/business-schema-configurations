...
```json
{
  ...
  "properties": {
    ...
    "codiceFiscaleRappresentante": { "type": "string", "pattern": "^[A-Z]{6}[0-9]{2}[A-Z][0-9]{2}[A-Z][0-9]{3}[A-Z]$" },
    "numeroREA": { "type": "string" },
    "dataIscrizione": { "type": "string" },
    "statoAttivita": { "type": "string" },
    "oggettoSociale": { "type": "string" }
  },
  "required": ["ragioneSociale", "codiceFiscale", "sedeLegale", "formaGiuridica", "legaleRappresentante"]
}
```
