...
```json
{
  "type": "object",
  "properties": {
    "tipoFormalita": { "type": "string", "enum": ["compravendita", "ipoteca volontaria", "ipoteca giudiziale", "ipoteca legale", "ipoteca esattoriale", "pignoramento", "sequestro conservativo", "citazione", "domanda giudiziale", "cancellazione", "annotazione", "altro", null] },
    ...
    "soggetti": {
      ...
      "items": {
        ...
        "properties": {
          ...
          "ruolo": { "type": "string", "enum": ["proprietario", "creditore", "debitore", "garante", null] }
        },
  ...
  "required": ["tipoFormalita", "dataRegistrazione", "numeroRegistrazione", "soggetti", "immobile"]
}
```
